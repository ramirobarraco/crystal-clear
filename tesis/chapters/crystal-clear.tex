...
\vdash \sigma, \epsilon$ solo se puede aplicar la regla de reduccion \Var{Dename}
\sigmaprog{$\sigma$}{$\epsilon$}{\Var{Name}} \fullarrow \sigmaprog{$\sigma$}{$\epsilon$}{v}
...
entonces \Typetup{$\Gamma$}{$P_{i}$}{t} para todo i entre 1 y n.
