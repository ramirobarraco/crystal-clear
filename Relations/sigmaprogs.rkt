...
(define σϵ-rel
  (reduction-relation
   ...
   [-->σϵ/P (((r_1 v_1) ... (r_2 v_2) (r_3 v_3) ... ) : ((Name_1 r_1) ... (Name_2 r_2) (Name_3 r_3) ...) : (Name_2 = v))
            (((r_1 v_1) ... (r_2 v) (r_3 v_3) ... ) : ((Name_1 r_1) ... (Name_2 r_2) (Name_3 r_3) ...) : \;)
            reAssgn]

   [-->σϵ/P (σ_1 : ((Name_1 r_1) ...) : (Name_2 = v_2))
             (σ_2 : ((Name_2 r_2) (Name_1 r_1) ...) : \;)
            (side-condition (not (term (name-in? ((Name_1 r_1) ...) Name_2 ))))
            (where (σ_2 (r_2)) (addVal σ_1 (v_2)))
            Naming]

   
   [-->σϵ/P (((r_1 v_1) ... (r_2 v_2) (r_3 v_3) ... ) : ((Name_1 r_1) ... (Name_2 r_2) (Name_3 r_3) ...) : (t Name_2 = v))
            (((r_1 v_1) ... (r_2 v) (r_3 v_3) ... ) : ((Name_1 r_1) ... (Name_2 r_2) (Name_3 r_3) ...) : \;)
            typed-reAssgn]
